  ...
  <div class="resume_left">
    ...
    <div class="resume_section_text section">
      <ul class="resume_list">
        <li>Experienced programmer in Java, Python, C, C++, Visual Basic, Javascript, JQuery, PHP, Lisp (Scheme), and MIPS</li>
        <li>Experience developing Android, Django, Symfony, and Ruby on Rails applications</li>
        <li>Knowledge of Unix, Linux (Debian), Windows, and Macintosh systems</li>
        <li>Able to collaborate well on projects through version control systems such as Git and Subversion</li>
      </ul>
    </div>
    <div class="resume_header">
      Relevant Coursework
    </div>
    <div id="course_work" v-courses class="resume_section_text section">
      <div class="course">
      ...
      <div class="course">
        ...
        <div id="164" class="course_text">
          ...
          <ul class="resume_list">
            ...
            <li>
              Principles and techniques of scanning, parsing, semantic analysis, and code generation.
              Implementation of compilers, interpreters, and assemblers. Overview of run-time organization and error handling.
            </li>
          </ul>
        </div>
      </div>
        ...
        <div id="122" class="course_text">
          ...
          <ul class="resume_list">
            <li>
              ...
              focusing on the concepts and fundamental design principles
              that have contributed to the Internet's scalability and robustness.
            </li>
            <li>
              Topics include layering, congestion/flow/error control, routing, addressing,
              multicast, packet scheduling, switching, internetworking, network security,
  ...
  <div class="resume_right">
    ...
    <div class="resume_section_text section">
      ...
      <ul class="resume_list">
        ...
        <li>
          Project that will significantly improve the effectiveness and efficiency of analyzing, predicting, and designing
          natural gas production from extremely tight unconventional gas reservoirs.
        </li>
      </ul>
      <div class="resume_text_title">
      ...
      <ul class="resume_list">
        ...
        <li>
          Worked with LBNL researcher Dr. Jinsong Chen writing code to statistically analyze
          inverted geological data and developed a web based interface for Dr. Chen's stochastic inversion codes
        </li>
