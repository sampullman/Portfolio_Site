...
function loadSprites(c, player, enemyLoadFn, buttonLoadFn) {
  ...
  player.sprites = [
    Sprite('player.png', w, h),
    Sprite('playerLeft.png', w, h),
    Sprite('playerRight.png', w, h),
  ]
  Enemy1Obj.sprite = Sprite(
    'enemy1.png',
    gameState.enemyData.width,
    gameState.enemyData.height,
    enemyLoadFn,
  )
  Enemy2Obj.sprite = Sprite(
    'enemy2.png',
    gameState.enemyData.width,
    gameState.enemyData.height,
    enemyLoadFn,
  )
  Enemy3Obj.sprite = Sprite(
    'enemy3.png',
    gameState.enemyData.width,
    gameState.enemyData.height,
    enemyLoadFn,
  )
  Enemy4Obj.sprite = Sprite(
    'enemy4.png',
    gameState.enemyData.width,
    gameState.enemyData.height,
    enemyLoadFn,
  )
  Enemy5Obj.sprite = Sprite(
    'enemy5.png',
    gameState.enemyData.width * 2,
    gameState.enemyData.height * 2,
    enemyLoadFn,
  )
  Enemy6Obj.sprite = Sprite(
    'enemy6.png',
    gameState.enemyData.width,
    gameState.enemyData.height,
    enemyLoadFn,
  )
  Enemy7Obj.sprite = Sprite(
    'enemy7.png',
    gameState.enemyData.width,
    gameState.enemyData.height,
    enemyLoadFn,
  )
  Enemy8Obj.sprite = Sprite(
    'enemy8.png',
  ...
  sprites.playerShot = [
    Sprite('laserRed.png', shotW, shotH),
    Sprite('laserRedShot.png', 28, 28),
  ]
  sprites.enemyShot = [
    Sprite('laserGreen.png', shotW, shotH),
    Sprite('laserGreenShot.png', 28, 28),
  ]
  sprites.playerLife = Sprite('life.png', w / 2, h / 2)
  sprites.explosions.push(
    Sprite('explosion1.png', gameState.enemyData.width, gameState.enemyData.height),
  )
  sprites.explosions.push(
    Sprite('explosion2.png', gameState.enemyData.width, gameState.enemyData.height),
  )
  sprites.explosions.push(
    Sprite('explosion3.png', gameState.enemyData.width, gameState.enemyData.height),
  )
  sprites.explosions.push(
    Sprite('explosion4.png', gameState.enemyData.width, gameState.enemyData.height),
  )
  ...
  Enemy9Obj.sprite = Sprite(
    'enemy9.png',
    gameState.enemyData.width * 3,
    gameState.enemyData.height * 3,
  )
  sprites.star = Sprite('star.png', 16, 16, initStars)
  sounds.shot = new Sound(['/src/static/sounds/shot.mp3', '/src/static/sounds/shot.ogg'])
  sounds.enemyShot = new Sound([
    '/src/static/sounds/enemy_shot.mp3',
    '/src/static/sounds/enemy_shot.ogg',
  ])
  sounds.enemyExp = new Sound([
    '/src/static/sounds/enemy_exp.mp3',
    '/src/static/sounds/enemy_exp.ogg',
  ])
  sounds.ambient = new Sound(['/src/static/sounds/ambience.mp3'])
  sounds.laser = new Sound([
    '/src/static/sounds/laser.mp3',
    '/src/static/sounds/laser.ogg',
  ])
}
