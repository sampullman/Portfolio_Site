...
import { enemyData, enemy1Obj, enemy2Obj, enemy3Obj, enemy4Obj,enemy5Obj, enemy6Obj, enemy7Obj, enemy8Obj } from './space_enemies.js';
import { player, Sound } from './space_objects.js';
...
export { sprites, loadSprites, shotW, shotH };

function loadSprites(c, loadFn) {
    ...
    enemy1Obj.sprite = Sprite('631wm7d11mdr3mj/7oPa2yNaIB/portfolio/static/images/space_sprites/enemy1.png', enemyData.width, enemyData.height, loadFn);
    enemy2Obj.sprite = Sprite('631wm7d11mdr3mj/nTAY8QygYM/portfolio/static/images/space_sprites/enemy2.png', enemyData.width, enemyData.height, loadFn);
    enemy3Obj.sprite = Sprite('631wm7d11mdr3mj/ok-JoalkfC/portfolio/static/images/space_sprites/enemy3.png', enemyData.width, enemyData.height, loadFn);
    enemy4Obj.sprite = Sprite('631wm7d11mdr3mj/xK3PxxAch8/portfolio/static/images/space_sprites/enemy4.png', enemyData.width, enemyData.height, loadFn);
    enemy5Obj.sprite = Sprite('631wm7d11mdr3mj/qQ5Kzklhyy/portfolio/static/images/space_sprites/enemy5.png', enemyData.width * 2, enemyData.height * 2, loadFn);
    enemy6Obj.sprite = Sprite('631wm7d11mdr3mj/6roKA0hqDT/portfolio/static/images/space_sprites/enemy6.png', enemyData.width, enemyData.height, loadFn);
    enemy7Obj.sprite = Sprite('631wm7d11mdr3mj/8-8aF0Hgmf/portfolio/static/images/space_sprites/enemy7.png', enemyData.width, enemyData.height, loadFn);
    enemy8Obj.sprite = Sprite('631wm7d11mdr3mj/sahm-t_RnK/portfolio/static/images/space_sprites/enemy8.png', enemyData.width * 3, enemyData.height, loadFn);
    ...
    sprites.pause = Sprite('631wm7d11mdr3mj/PjnX4rAH7y/portfolio/static/images/space_sprites/pause.png', 32, 32, drawButtons);
    sprites.play = Sprite('631wm7d11mdr3mj/cc7mbxDjlT/portfolio/static/images/space_sprites/play.png', 32, 32, drawButtons);
    sprites.soundOn = Sprite('631wm7d11mdr3mj/RaJHuLjaHG/portfolio/static/images/space_sprites/sound_on.png', 32, 32, drawButtons);
    sprites.soundOff = Sprite('631wm7d11mdr3mj/Ih0P0EL4Id/portfolio/static/images/space_sprites/sound_off.png', 32, 32, drawButtons);
    ...
    sprite.star = Sprite('631wm7d11mdr3mj/4uGpI1uGwu/portfolio/static/images/space_sprites/star.png', 16, 16, initStars);
    sounds.shot = Sound([
