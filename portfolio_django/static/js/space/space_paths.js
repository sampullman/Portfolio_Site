...
function FollowPlayer(E, duration) {
    this.E = E;
    this.finished = false;
	...
	} else if(this.duration <= 0 || this.E.y > C_WIDTH - 1.5*this.E.height) {
...
function followPlayerPath(E, duration) {
    this.E = E;
    this.duration = duration || 90;
    this.instantiate = function() {
	return new FollowPlayer(E, this.duration);
    };
    this.clone = function(entity) {
	return new FollowPlayer(entity, this.duration);
    }
    return this;
}

function avoidPlayerPath(E, duration) {
    this.E = E;
...
function randomVerticalInit(E, minDur) {
...
function randomHorizontalInit(E, minDur) {
    this.minDur = minDur || 0;
    this.instantiate = function() {
